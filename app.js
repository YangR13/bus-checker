...
io.on('connection', function(socket){
	socket.on('data request', function(msg){
		
		console.log('place and time: '+ msg);
		
		// DO THINGS HERE KEVIN
		
		var reply = getTestData();
		socket.emit('data package', reply);
	});
});
